...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst_libs/gst/vulkan/xcb/gstvkwindow_xcb.h"
#endif
...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst_libs/gst/vulkan/cocoa/gstvkwindow_cocoa.h"
#endif
#if GST_VULKAN_HAVE_WINDOW_IOS
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst_libs/gst/vulkan/ios/gstvkwindow_ios.h"
#endif
#if GST_VULKAN_HAVE_WINDOW_WIN32
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst_libs/gst/vulkan/win32/gstvkwindow_win32.h"
#endif
#if GST_VULKAN_HAVE_WINDOW_ANDROID
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst_libs/gst/vulkan/android/gstvkwindow_android.h"
#endif
