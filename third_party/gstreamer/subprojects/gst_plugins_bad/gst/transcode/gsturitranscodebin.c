...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst/transcode/gsttranscoding.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst/transcode/gsttranscodeelements.h"
#if HAVE_GETRUSAGE
#include "third_party/gstreamer/subprojects/gst_plugins_bad/gst/transcode/gst-cpu-throttling-clock.h"
#endif
