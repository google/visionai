...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/musepack/gstmusepackdec.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/musepack/gstmusepackreader.h"
