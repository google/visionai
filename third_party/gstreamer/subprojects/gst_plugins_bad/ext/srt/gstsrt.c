...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/srt/gstsrtelements.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/srt/gstsrtsrc.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/srt/gstsrtsink.h"
