...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/resindvd/gstmpegdefs.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/resindvd/gstpesfilter.h"
