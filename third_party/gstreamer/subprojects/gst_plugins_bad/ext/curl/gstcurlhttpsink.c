...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/curl/gstcurltlssink.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/curl/gstcurlhttpsink.h"
