...
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/curl/gstcurlbasesink.h"
#include "third_party/gstreamer/subprojects/gst_plugins_bad/ext/curl/gstcurlfilesink.h"
