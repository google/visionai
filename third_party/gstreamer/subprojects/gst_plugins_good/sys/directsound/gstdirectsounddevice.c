...
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/directsound/gstdirectsounddevice.h"
...
#else
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/directsound/gstdirectsoundsink.h"
#endif
