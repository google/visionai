...
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/osxaudio/gstosxaudiosrc.h"
#ifndef HAVE_IOS
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/osxaudio/gstosxaudiodeviceprovider.h"
#endif
