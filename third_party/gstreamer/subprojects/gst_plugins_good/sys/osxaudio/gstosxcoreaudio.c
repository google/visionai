...
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/osxaudio/gstosxcoreaudiocommon.h"
...
#ifdef HAVE_IOS
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/osxaudio/gstosxcoreaudioremoteio.c"
#else
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/osxaudio/gstosxcoreaudiohal.c"
#endif
