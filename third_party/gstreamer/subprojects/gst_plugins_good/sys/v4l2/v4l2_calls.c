...
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/v4l2/gstv4l2tuner.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/sys/v4l2/gstv4l2colorbalance.h"
