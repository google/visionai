...
#include <string.h>
#include "third_party/gstreamer/subprojects/gst_plugins_good/gst/monoscope/gstmonoscope.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/gst/monoscope/monoscope.h"
