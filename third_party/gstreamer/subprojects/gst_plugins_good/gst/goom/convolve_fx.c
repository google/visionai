...
#include "third_party/gstreamer/subprojects/gst_plugins_good/gst/goom/motif_goom1.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/gst/goom/motif_goom2.h"
