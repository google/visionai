...
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/jpeg/smokecodec.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/jpeg/smokeformat.h"
