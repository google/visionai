...
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/libpng/gstpngdec.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/libpng/gstpngenc.h"
