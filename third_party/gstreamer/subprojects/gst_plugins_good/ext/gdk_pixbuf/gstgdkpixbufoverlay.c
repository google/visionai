...
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/gdk_pixbuf/gstgdkpixbufoverlay.h"

#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/gdk_pixbuf/gstgdkpixbufelements.h"
