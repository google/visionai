...
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/soup/gstsouphttpsrc.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/soup/gstsouphttpclientsink.h"
