...
#include <string.h>
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/libcaca/gstcacasink.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/libcaca/gstcacatv.h"
