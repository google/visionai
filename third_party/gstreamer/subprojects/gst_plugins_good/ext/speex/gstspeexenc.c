...
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/speex/gstspeexelements.h"
#include "third_party/gstreamer/subprojects/gst_plugins_good/ext/speex/gstspeexenc.h"
