...
#include "third_party/gstreamer/subprojects/gst_plugins_base/gst_libs/gst/tag/gsttageditingprivate.h"
#include <stdlib.h>
#include <string.h>

#include "third_party/gstreamer/subprojects/gst_plugins_base/gst_libs/gst/tag/id3v2.h"
