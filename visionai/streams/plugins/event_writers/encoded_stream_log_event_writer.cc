...
absl::Status EncodedStreamLogEventWriter::Init(EventWriterInitContext* ctx) {
  return absl::OkStatus();
}

absl::Status EncodedStreamLogEventWriter::Open(absl::string_view event_id) {
  event_id_ = std::string(event_id);
  return absl::OkStatus();
}

absl::Status EncodedStreamLogEventWriter::Write(Packet p) {
...
absl::Status EncodedStreamLogEventWriter::Close() {
  return absl::OkStatus();
}

std::string EncodedStreamLogEventWriter::AssembleGstreamerPipeline() {
