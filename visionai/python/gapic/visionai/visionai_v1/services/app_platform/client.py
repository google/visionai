...
class AppPlatformClient(metaclass=AppPlatformClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, AppPlatformTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, AppPlatformTransport]): The
        ...
        if isinstance(transport, AppPlatformTransport):
    ...
    def list_applications(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.app_platform.pagers.ListApplicationsPager:
        ...
        # in a platform.ListApplicationsRequest.
    ...
    def get_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.GetApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.CreateApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UpdateApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.DeleteApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def deploy_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.DeployApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def undeploy_application(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UndeployApplicationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def add_application_stream_input(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.AddApplicationStreamInputRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def remove_application_stream_input(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.RemoveApplicationStreamInputRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_application_stream_input(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UpdateApplicationStreamInputRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_instances(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.app_platform.pagers.ListInstancesPager:
                Message for response to listing
                Instances.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.ListInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_instance(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.GetInstanceRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_application_instances(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.CreateApplicationInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_application_instances(self,
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                The result type for the operation will be
                :class:`google.cloud.visionai_v1.types.Instance` Message
                describing Instance object
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.DeleteApplicationInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_application_instances(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UpdateApplicationInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_drafts(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.app_platform.pagers.ListDraftsPager:
                Message for response to listing
                Drafts.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.ListDraftsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_draft(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.CreateDraftRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_draft(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UpdateDraftRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_draft(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.DeleteDraftRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_processors(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.app_platform.pagers.ListProcessorsPager:
                Message for response to listing
                Processors.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.ListProcessorsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_prebuilt_processors(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.ListPrebuiltProcessorsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_processor(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.GetProcessorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_processor(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.CreateProcessorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_processor(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.UpdateProcessorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_processor(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a platform.DeleteProcessorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
