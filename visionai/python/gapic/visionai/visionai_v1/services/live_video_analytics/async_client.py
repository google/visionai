...
class LiveVideoAnalyticsAsyncClient:
    ...
    def __init__(self, *,
            ...
            transport: Union[str, LiveVideoAnalyticsTransport] = "grpc_asyncio",
    ...
    async def resolve_operator_info(self,
    ...
    async def list_operators(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListOperatorsAsyncPager:
    ...
    async def delete_operator(self,
    ...
    async def list_analyses(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListAnalysesAsyncPager:
                Message for response to listing
                Analyses
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def list_processes(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListProcessesAsyncPager:
                Message for response to listing
                Processes.
                Iterating over this object will yield
                results and resolve additional pages
    ...
    async def batch_run_process(self,
