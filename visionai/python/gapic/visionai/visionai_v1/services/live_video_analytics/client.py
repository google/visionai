...
class LiveVideoAnalyticsClient(metaclass=LiveVideoAnalyticsClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, LiveVideoAnalyticsTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, LiveVideoAnalyticsTransport]): The
        ...
        if isinstance(transport, LiveVideoAnalyticsTransport):
    ...
    def resolve_operator_info(self,
        ...
        # in a lva_service.ResolveOperatorInfoRequest.
    ...
    def list_operators(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListOperatorsPager:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.ListOperatorsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_operator(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.GetOperatorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_operator(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.CreateOperatorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_operator(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.UpdateOperatorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_operator(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.DeleteOperatorRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_analyses(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListAnalysesPager:
                Message for response to listing
                Analyses
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.ListAnalysesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_analysis(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.GetAnalysisRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_analysis(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.CreateAnalysisRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_analysis(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.UpdateAnalysisRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_analysis(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.DeleteAnalysisRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def list_processes(self,
        ...
        Returns:
            visionai.python.gapic.visionai.visionai_v1.services.live_video_analytics.pagers.ListProcessesPager:
                Message for response to listing
                Processes.
                Iterating over this object will yield
                results and resolve additional pages
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.ListProcessesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def get_process(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.GetProcessRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def create_process(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.CreateProcessRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def update_process(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.UpdateProcessRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def delete_process(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.DeleteProcessRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
    ...
    def batch_run_process(self,
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a lva_service.BatchRunProcessRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
