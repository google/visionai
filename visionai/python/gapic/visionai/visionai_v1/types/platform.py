...
from visionai.python.gapic.visionai.visionai_v1.types import annotations as gcv_annotations
...
class ModelType(proto.Enum):
    ...
    Values:
        ...
        OCR (11):
            Model Type OCR.
        LABEL_DETECTION (12):
            Model Type Label Detection.
        EMBEDDING (13):
            Model Type Embedding.
        PRODUCT_DETECTOR (14):
            Model Type  Product Detector.
    """
    MODEL_TYPE_UNSPECIFIED = 0
    IMAGE_CLASSIFICATION = 1
    OBJECT_DETECTION = 2
...
class DataType(proto.Enum):
    ...
    Values:
        ...
        VISUAL_FRAME (5):
            A visual frame data type, indicating support for ``VIDEO``
...
class DeploymentEnvironment(proto.Enum):
    r"""enum describes the environment that a resource belongs to.

    Values:
        DEPLOYMENT_ENVIRONMENT_UNSPECIFIED (0):
            Unspecified deployment environment.
        DEPLOYMENT_ENVIRONMENT_CLOUD (1):
            Resource is deployed to cloud env. e.g.
            streams.
        DEPLOYMENT_ENVIRONMENT_EDGE (2):
            Resource is deployed to edge env. e.g. smart
            devices.
    """
    DEPLOYMENT_ENVIRONMENT_UNSPECIFIED = 0
    DEPLOYMENT_ENVIRONMENT_CLOUD = 1
...
class DeployApplicationRequest(proto.Message):
    ...
    Attributes:
        ...
        deployment_environment (google.cloud.visionai_v1.types.DeploymentEnvironment):
            Which environment this application is
            deployed.
    """
    ...
    deployment_environment: 'DeploymentEnvironment' = proto.Field(
        proto.ENUM,
        number=5,
...
class Application(proto.Message):
    ...
    Attributes:
        ...
        notification_settings (google.cloud.visionai_v1.types.OperationNotificationSettings):
            Notification settings for various operations
            on an application.
    ...
    class ApplicationRuntimeInfo(proto.Message):
        ...
        Attributes:
            ...
            monitoring_config (google.cloud.visionai_v1.types.Application.ApplicationRuntimeInfo.MonitoringConfig):
                ...
                application.
            deployment_environment (google.cloud.visionai_v1.types.DeploymentEnvironment):
                The environment where the application is
                deployed.
        """
    ...
    notification_settings: 'OperationNotificationSettings' = proto.Field(
        proto.MESSAGE,
        number=11,
        message='OperationNotificationSettings',
    )
...
class OperationNotificationSettings(proto.Message):
    r"""Notification settings for how to contact a user on various
    operations.

    Attributes:
        contact_settings (MutableSequence[google.cloud.visionai_v1.types.OperationNotificationSettings.OperationContactSettings]):
            Settings for various contact methods; up to 3
            methods are supported.
    """

    class OperationContactSettings(proto.Message):
        r"""Contact settings for LROs/batch operations.
        ...
        Attributes:
            email_contact (google.cloud.visionai_v1.types.OperationNotificationSettings.OperationContactSettings.EmailContact):
                An email contact method.

                This field is a member of `oneof`_ ``contact_method``.
            pubsub_contact (google.cloud.visionai_v1.types.OperationNotificationSettings.OperationContactSettings.PubSubContact):
                A Pub/Sub contact method.

                This field is a member of `oneof`_ ``contact_method``.
        """

        class EmailContact(proto.Message):
            r"""Describes email contacts.

            Attributes:
                email_address (str):
                    An email address to contact for an operation. If the string
                    specified is "USER_EMAIL", App Platform will try to deduce
                    the email of a user based on the request.
            """
        ...
        class PubSubContact(proto.Message):
            r"""Describes Pub/Sub contacts.

            Attributes:
                topic (str):
                    The resource name of the topic; of the form
                    ``projects/{project}/topics/{topic}``. The schema associated
                    with a Pub/Sub topic should follow a
        ...
        email_contact: 'OperationNotificationSettings.OperationContactSettings.EmailContact' = proto.Field(
            proto.MESSAGE,
            number=1,
            oneof='contact_method',
            message='OperationNotificationSettings.OperationContactSettings.EmailContact',
        )
        pubsub_contact: 'OperationNotificationSettings.OperationContactSettings.PubSubContact' = proto.Field(
            proto.MESSAGE,
            number=2,
            oneof='contact_method',
            message='OperationNotificationSettings.OperationContactSettings.PubSubContact',
        )

    contact_settings: MutableSequence[OperationContactSettings] = proto.RepeatedField(
        proto.MESSAGE,
        number=1,
        message=OperationContactSettings,
    )
...
class Processor(proto.Message):
    ...
    Attributes:
        ...
        compatible_deployment_environment (MutableSequence[google.cloud.visionai_v1.types.DeploymentEnvironment]):
            The environments the processor is compatible
            with. Should match with the Application's, that
            the processor is used in.
    ...
    compatible_deployment_environment: MutableSequence['DeploymentEnvironment'] = proto.RepeatedField(
        proto.ENUM,
        number=16,
        enum='DeploymentEnvironment',
    )
...
class ProcessorConfig(proto.Message):
    ...
    Attributes:
        ...
        big_query_config (google.cloud.visionai_v1.types.BigQueryConfig):
            ...
            This field is a member of `oneof`_ ``processor_config``.
        local_output_config (google.cloud.visionai_v1.types.LocalOutputConfig):
            Configs of Local Output Processor
        ...
        universal_input_config (google.cloud.visionai_v1.types.UniversalInputConfig):
            ...
            This field is a member of `oneof`_ ``processor_config``.
        label_detector_config (google.cloud.visionai_v1.types.LabelDetectorConfig):
            Runtime configs of Label Detector processor.

            This field is a member of `oneof`_ ``processor_config``.
        embeddings_extractor_config (google.cloud.visionai_v1.types.EmbeddingsExtractorConfig):
            Runtime configs of the Embeddings Extractor
            Processor.

            This field is a member of `oneof`_ ``processor_config``.
        product_detector_config (google.cloud.visionai_v1.types.ProductDetectorConfig):
            Runtime configs of Product Detector
            processor.

            This field is a member of `oneof`_ ``processor_config``.
        post_processing_config (google.cloud.visionai_v1.types.PostProcessingConfig):
            Configs of processor's postProcessingConfig.
    ...
    local_output_config: 'LocalOutputConfig' = proto.Field(
        proto.MESSAGE,
        number=24,
        oneof='processor_config',
        message='LocalOutputConfig',
    )
    ...
    label_detector_config: 'LabelDetectorConfig' = proto.Field(
        proto.MESSAGE,
        number=29,
        oneof='processor_config',
        message='LabelDetectorConfig',
    )
    embeddings_extractor_config: 'EmbeddingsExtractorConfig' = proto.Field(
        proto.MESSAGE,
        number=31,
        oneof='processor_config',
        message='EmbeddingsExtractorConfig',
    )
    product_detector_config: 'ProductDetectorConfig' = proto.Field(
        proto.MESSAGE,
        number=32,
        oneof='processor_config',
        message='ProductDetectorConfig',
    )
    post_processing_config: 'PostProcessingConfig' = proto.Field(
        proto.MESSAGE,
        number=23,
...
class LocalOutputConfig(proto.Message):
    r"""Message describing processor's LocalOutputConfig.

    Attributes:
        dir_path (str):
            The folder path for where the output is
            stored.
    """

    dir_path: str = proto.Field(
        proto.STRING,
        number=1,
    )
...
class LabelDetectorConfig(proto.Message):
    r"""Message describing LabelDetectorConfig.

    Attributes:
        custom_labels (MutableSequence[str]):
            A list of custom labels to be checked upon
            the incoming images up to 64 labels are
            supported with a maximum length of 16 characters
            for each (labels longer than 16 characters will
            be truncated).
    """
...
class EmbeddingsExtractorConfig(proto.Message):
    r"""Message describing EmbeddingsExtractorConfig.

    Attributes:
        contextual_texts (MutableSequence[str]):
            The contextual texts related to the image. If not empty, for
            each attached image, the text embedding will be generated
            together with the image embedding. Currently up to 8
            ``contextual_texts`` in one prediction are allowed with a
            maximum length of 64 for each contextual text.
    """

    contextual_texts: MutableSequence[str] = proto.RepeatedField(
        proto.STRING,
        number=1,
    )
...
class ProductDetectorConfig(proto.Message):
    r"""Message describing ProductDetectorConfig.

    Attributes:
        product_detection_confidence_threshold (float):
            Optional. The product detection confidence
            threshold.
    """

    product_detection_confidence_threshold: float = proto.Field(
        proto.FLOAT,
        number=1,
    )
...
class PostProcessingConfig(proto.Message):
    r"""Message describe processor's PostProcessingConfig.
    ...
    Attributes:
        post_processing_cloud_function (str):
            ...
            -  The cloud function will receive
               AppPlatformCloudFunctionRequest where the annotations
               field will be the json format of proto output of the
               target processor.
            -  The cloud function should return
               AppPlatformCloudFunctionResponse where the annotations
               field should contains the json format of desired proto
               Message.
            -  To drop the annotations output, simply clear the
               annotations field in the returned
               AppPlatformCloudFunctionResponse.
            -  if annotation_passthrough is set to true, the input
               protoMessage will be returned instead, even if the
